...
sfdx force:user:create username=sajesh@$1 email=sajesh.radhakrishnan@salesforce.com FirstName=Sajesh LastName=Radhakrishnan Alias=sajesh -s generatepassword=true profileName="Interviewer" -u $1 &&
sfdx force:user:create username=kpahlajani@$1 email=kpahlajani@salesforce.com FirstName=Kumar LastName=Pahlajani Alias=kpahl -s generatepassword=true profileName="Platform Interviewer" -u $1 &&
